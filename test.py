...
parser.add_argument('--checkpoint', type=str,
                    default='/home/lay/lay/code/Work2_a/DC_STGNet/logs/2023-10-31-11:48:57-PEMS04/best_model.pth', help='')
...
def main():
    ...
    torch.save(realy,"WMSTA_04real.pt")
    torch.save(yhat1,"WMSTA_04pred.pt")
